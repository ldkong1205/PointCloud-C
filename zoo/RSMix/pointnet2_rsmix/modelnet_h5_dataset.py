...
class ModelNetH5Dataset(object):
    ...
    def next_batch(self, augment=False, convda=False, rddrop=False, p_mix_prob=0.5, beta=0.0, 
        ...
        if augment: 
            ...
            if beta > 0 and r < p_mix_prob:
                data_batch, lam, label_batch, label_batch_b = self._rsmix_batch_data(data_batch, label_batch, beta=beta, n_sample=512)
        '''
        to here
        '''
        return data_batch, label_batch, lam, label_batch_b
