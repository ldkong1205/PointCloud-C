...
from data_util import PartNormalDataset, ShapeNetPart
...
def train(args, io):
    ...
    test_loader = DataLoader(test_data, batch_size=16, shuffle=False, num_workers=args.workers, drop_last=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_name', type=str, default='train1', metavar='N',
